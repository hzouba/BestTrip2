 ...
 */
class Feedback extends \Admin\AdminBundle\Entity\Feedback implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setRaiting($raiting);
    }

    public function getRaiting()
    {
        $this->__load();
        return parent::getRaiting();
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'idUser', 'idExperience', 'comment', 'raiting');
    }
