 ...
 */
class ExperienceGuide extends \Admin\AdminBundle\Entity\ExperienceGuide implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setIdGuide($idGuide);
    }
    ...
    {
        return array('__isInitialized__', 'idGuide', 'idExperience');
    }
